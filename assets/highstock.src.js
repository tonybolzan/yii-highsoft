...
defaultOptions = {
	...
	global: {
		useUTC: true,
		canvasToolsURL: 'http://code.highcharts.com/stock/1.3.0/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code.highcharts.com/stock/1.3.0/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
